...
public class ProblemData {
	...
	private String examNameFromFile;
	...
	public String readDataFromExcelFile()
	{
		...
		try {
			...
			this.examNameFromFile = this.readSettingValue(workbook.getSheet("Setting"), "ExamType");

			if (this.examNameFromFile == null || this.examNameFromFile.equals(""))
			{
				this.examNameFromFile = this.examType;

			}
			this.examType = this.examNameFromFile;
		...
		catch (Exception e)
		{
			...
			System.out.println(this.examType);
			System.out.println(this.examNameFromFile);
			return "An Error Occurred while reading the Student Course file.!"; //while vs in to differentite from above IOException
