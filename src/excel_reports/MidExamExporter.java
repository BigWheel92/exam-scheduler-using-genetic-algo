...
public class MidExamExporter extends ExamExporter {

	public MidExamExporter(ProblemData problemData, Chromosome bestSchedule, String outputFileName) {
	...
	public void setDateSheetDayDateHeader(Sheet sheet)
	{
	...
	public void printDateSheet(Sheet completeSheet, String dept)
	{
		...
		completeSheet.autoSizeColumn(0);
		completeSheet.autoSizeColumn(1);
		for (int i = 2; i < this.problemData.getTotalSlotsPerDay() * 2 + 2; i++)
		{
			completeSheet.setColumnWidth(20, i);
	...
	public String exportDateSheetToExcel()
	{
		try {
			...
			setDatesheetNameHeader(CSsheet, "DATE SHEET FOR MID TERM EXAMINATION (CS DEPT)");
			setDatesheetNameHeader(MGsheet, "DATE SHEET FOR MID TERM EXAMINATION (MG DEPT)");
			setDatesheetNameHeader(EEsheet, "DATE SHEET FOR MID TERM EXAMINATION (EE DEPT)");
			setDatesheetNameHeader(CVsheet, "DATE SHEET FOR MID TERM EXAMINATION (CV DEPT)");
			...
			this.setDateSheetDayDateHeader(CSsheet);
			this.setDateSheetDayDateHeader(MGsheet);
			this.setDateSheetDayDateHeader(EEsheet);
			this.setDateSheetDayDateHeader(CVsheet);
			this.setDateSheetDayDateHeader(completeSheet);
